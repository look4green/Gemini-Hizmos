...
// TwoWire myWire(0); // 🛑 REMOVED: Using global 'Wire' for I2C on custom pins
// 🟢 CHANGED: Use global 'Wire' object, which is initialized on pins 8 & 9 below
...
void setup() {
  ...
  // 🟢 ADDED: Initialize the Wire (I2C) bus on your custom pins (GPIO 8 & 9)
  // This is required for U8G2_..._HW_I2C and the NFC module to use the correct S3 pins
