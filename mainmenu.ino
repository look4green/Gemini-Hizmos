#include <Arduino.h> // Standard Arduino/C++ header

// Assuming the U8G2 library and object are set up globally.
// Replace with your specific display model if necessary.
// For example:
...
// --- FORWARD DECLARATIONS (Needed for runLoop and menu actions) ---
...
void handlesubghzmenu(); // Corrected placeholder for index 1
void handlegpiomenu();
...
// --- ICON FRAME DATA (Keep all your original data here) ---

// Your provided data (omitted for brevity, but must be included here):
/*
static const unsigned char infrared_frame0[] U8X8_PROGMEM = {0xf8,0x07,...};
...
static const unsigned char image_selection_bar_bits[] U8X8_PROGMEM = {0xf8, 0xff,...};
*/
